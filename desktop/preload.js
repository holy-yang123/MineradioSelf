...
contextBridge.exposeInMainWorld('desktopWindow', {
  ...
  getAppSettings: () => ipcRenderer.invoke('mineradio-app-settings-get'),
  setAppSettings: (patch) => ipcRenderer.invoke('mineradio-app-settings-set', patch || {}),
  quitApp: () => ipcRenderer.invoke('mineradio-app-quit'),
